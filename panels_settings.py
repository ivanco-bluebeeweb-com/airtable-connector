"""Settings panel for Airtable Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__airtable_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=airtable_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_airtable"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Airtable Settings & Accounts", level=2),
